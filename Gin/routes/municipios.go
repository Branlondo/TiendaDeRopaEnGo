// municipios.go — mapa de departamentos → municipios de Colombia.
...
var municipiosColombia = map[string][]string{
	"Amazonas": {
	...
	"Antioquia": {
		...
		"Argelia", "Armenia", "Barbosa", "Bello", "Betania", "Briceño",
		...
		"Concordia", "Copacabana", "Dabeiba", "Don Matías", "Ebéjico",
		"El Bagre", "El Carmen de Viboral", "El Retiro", "Entrerríos", "Envigado",
		...
		"Murindó", "Mutatá", "Nariño", "Necoclí", "Nechí", "Olaya", "Peñol",
		"Peque", "Puerto Berrío", "Puerto Nare", "Puerto Triunfo", "Remedios",
		"Rionegro", "Sabaneta", "Salgar", "San Andrés de Cuerquia", "San Carlos",
		"San Francisco", "San Jerónimo", "San José de la Montaña", "San Juan de Urabá",
		"San Luis", "San Pedro de los Milagros", "San Pedro de Urabá", "San Rafael",
		"San Roque", "San Vicente Ferrer", "Santa Bárbara", "Santa Fe de Antioquia",
		"Santa Rosa de Osos", "Santo Domingo", "Santuario", "Segovia", "Sonsón",
		"Sopetrán", "Tarazá", "Tarso", "Titiribí", "Toledo", "Turbo", "Uramita",
	...
	"Atlántico": {
		...
		"Piojó", "Polo Nuevo", "Ponedera", "Puerto Colombia", "Repelón",
	...
	"Bolívar": {
		...
		"Barranco de Loba", "Calamar", "Cantagallo", "Carmen de Bolívar",
		"Cartagena", "Cicuco", "Clemencia", "Córdoba", "El Guamo",
		"El Peñón", "Hatillo de Loba", "Magangué", "Mahates", "Margarita",
		"María la Baja", "Montecristo", "Mompós", "Morales", "Norosí",
	...
	"Boyacá": {
		...
		"Chiscas", "Chita", "Chitaraque", "Ciénega", "Cómbita", "Coper",
		"Corrales", "Covarachía", "Cubará", "Cucaita", "Cuítiva", "Duitama",
		"El Cocuy", "El Espino", "Firavitoba", "Floresta", "Gachantivá",
		"Gameza", "Garagoa", "Guacamayas", "Guateque", "Guayatá", "Güicán",
		"Iza", "Jenesano", "Jericó", "La Capilla", "La Uvita", "La Victoria",
		...
		"San Mateo", "San Miguel de Sema", "San Pablo de Borbur", "Santana",
		"Santa María", "Santa Rosa de Viterbo", "Santa Sofía", "Sativasur",
		"Sativanorte", "Siachoque", "Soatá", "Socotá", "Socha", "Sogamoso",
		...
		"Turmequé", "Tuta", "Tutazá", "Úmbita", "Úngüía", "Ventaquemada",
	...
	"Cauca": {
		...
		"Cajibío", "Caldono", "Caloto", "Coconuco", "Corinto",
		"El Tambo", "Florencia", "Guachené", "Guapí", "Inzá",
		"Jambaló", "La Sierra", "La Vega", "López de Micay", "Mercaderes",
		"Miranda", "Morales", "Padilla", "Páez", "Patía", "Piamonte",
		"Piendamó", "Popayán", "Puerto Tejada", "Puracé", "Rosas",
	...
	"Chocó": {
		...
		"Medio San Juan", "Nóvita", "Nuquí", "Quibdó", "Río Iro",
		"Río Quito", "Riosucio", "San José del Palmar", "Sipí",
	...
	"Córdoba": {
		...
		"San Carlos", "San José de Uré", "San Pelayo", "Tierralta",
		"Tuchín", "Valencia",
	},
	"Cundinamarca": {
		...
		"Fosca", "Funza", "Fúquene", "Fusagasugá", "Gachala", "Gachancipá",
		"Gachetá", "Gama", "Girardot", "Granada", "Guachetá", "Guaduas",
		"Guasca", "Guataquí", "Guatavita", "Guayabal de Síquima", "Guayabetal",
		"Gutiérrez", "Jerusalén", "Junín", "La Calera", "La Mesa",
		"La Palma", "La Peña", "La Vega", "Lenguazaque", "Machetá",
		"Madrid", "Manta", "Medina", "Mosquera", "Nariño", "Nemocón",
		"Nilo", "Nimaima", "Nocaima", "Ospina Pérez", "Pacho", "Paime",
		...
		"Sasaima", "Sesquilé", "Sibaté", "Silvania", "Simijaca",
		"Soacha", "Sopó", "Subachoque", "Suesca", "Supatá", "Susa",
		"Sutatausa", "Tabio", "Tausa", "Tena", "Tibacuy", "Tibirita",
		"Tocaima", "Tocancipá", "Topaipí", "Ubalá", "Ubaque", "Une",
		"Útica", "Venecia", "Vergara", "Vianí", "Villagómez", "Villapinzón",
		"Villeta", "Viotá", "Yacopí", "Zipacón", "Zipaquirá",
	},
	"Guainía": {
		"Barranco Minas", "Cacahual", "Inírida", "La Guadalupe",
	...
	"Huila": {
		...
		"Campoalegre", "Colombia", "Elías", "Garzón", "Gigante",
		"Guadalupe", "Hobo", "Iquira", "Isnos", "La Argentina",
		"La Plata", "Nátaga", "Neiva", "Oporapa", "Paicol",
		"Palermo", "Palestina", "Pital", "Pitalito", "Rivera",
		"Saladoblanco", "San Agustín", "Santa María", "Suaza",
		"Tarqui", "Tesalia", "Tello", "Teruel", "Timaná",
		"Villavieja", "Yaguará",
	},
	"La Guajira": {
		"Albania", "Barrancas", "Dibula", "Distracción", "El Molino",
		"Fonseca", "Hatonuevo", "La Jagua del Pilar", "Maicao",
		"Manaure", "Riohacha", "San Juan del Cesar", "Uribia",
		"Urumita", "Villanueva",
	},
	"Magdalena": {
		...
		"Remolino", "Sabanas de San Ángel", "Salamina", "San Sebastián de Buena Vista",
	...
	"Nariño": {
		...
		"Buesaco", "Chachagüí", "Colón", "Consacá", "Contadero",
		...
		"Olaya Herrera", "Ospina", "Pasto", "Payán", "Policarpa",
		...
		"Santacruz", "Sapuyes", "Taminango", "Tangua", "Tumaco",
		"Túquerres", "Yacuanquer",
	},
	"Norte de Santander": {
		"Ábrego", "Arboledas", "Bochalema", "Bucarasica", "Cácota",
		"Cáchira", "Chinácota", "Chitagá", "Convención", "Cucutilla",
		"Cúcuta", "Durania", "El Carmen", "El Tarra", "El Zulia",
		...
		"Salazar", "San Calixto", "San Cayetano", "San José de Cúcuta",
		"San Martín", "Santiago", "Sardinata", "Silos", "Teorama",
		"Tibú", "Toledo", "Villa Caro", "Villa del Rosario",
	},
	"Putumayo": {
		"Colón", "Leguízamo", "Mocoa", "Orito", "Puerto Asís",
		"Puerto Caicedo", "Puerto Guzmán", "San Francisco", "San Miguel",
	...
	"San Andrés y Providencia": {
		"Providencia", "San Andrés", "Santa Catalina",
	},
	"Santander": {
		"Aguada", "Albania", "Aratoca", "Barbosa", "Barichara",
		"Barrancabermeja", "Betulia", "Bolívar", "Bucaramanga", "Cabrera",
		"California", "Capitanejo", "Carcasí", "Cepitá", "Cerrito",
		"Charalá", "Charta", "Chima", "Chipatá", "Cimitarra",
		"Concepción", "Confines", "Contratación", "Coromoro", "Curití",
		"El Carmen de Chucurí", "El Guacamayo", "El Peñón", "El Playón",
		"Encino", "Enciso", "Florián", "Floridablanca", "Galán",
		"Gámbita", "Girón", "Guaca", "Guadalupe", "Guapotá",
		"Güepsa", "Hato", "Jesús María", "Jordán", "La Belleza",
	...
	"Sucre": {
		"Buenavista", "Caimito", "Chalán", "Coloso", "Corozal",
		...
		"San Onofre", "San Pedro", "San Luis de Sincé", "Santiago de Tolú",
		"Sincelejo", "Sucre", "Tolú Viejo",
	},
	"Tolima": {
	...
	"Valle del Cauca": {
		...
		"Calima", "Candelaria", "Cartago", "Dagua", "El Águila",
		"El Cairo", "El Cerrito", "El Dovio", "Florida", "Ginebra",
		"Guacarí", "Guadalajara de Buga", "Jamundí", "La Cumbre",
		"La Unión", "La Victoria", "Obando", "Palmira", "Pradera",
		"Restrepo", "Riofrío", "Roldanillo", "San Pedro", "Sevilla",
		"Toro", "Trujillo", "Tuluá", "Ulloa", "Versalles",
		"Vijes", "Yotoco", "Yumbo", "Zarzal",
	},
	"Vaupés": {
		"Carurú", "Mitú", "Papunaua", "Taraira", "Yavaraté",
	},
	"Vichada": {
